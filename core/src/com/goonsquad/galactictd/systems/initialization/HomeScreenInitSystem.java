...
public class HomeScreenInitSystem extends InitializationSystem {
    ...
    private ComponentMapper<Spacial> spacialComponentMapper;
    ...
    private void createTitle() {
        ...
        Spacial titleSpacial = spacialComponentMapper.get(title);
        titleSpacial.setBounds(
    ...
    private void createPlayButton() {
        ...
        Spacial playSpacial = spacialComponentMapper.get(playButton);
        playSpacial.setBounds(
    ...
    private void createScoreButton() {
        ...
        Spacial scoreSpacial = spacialComponentMapper.get(scoreButton);
        scoreSpacial.setBounds(
    ...
    private void createQuitButton() {
        ...
        Spacial quitSpacial = spacialComponentMapper.get(quitButton);
        quitSpacial.setBounds(
    ...
    private void createSettingsButton() {
        ...
        Spacial quitSpacial = spacialComponentMapper.get(settingsButton);
        quitSpacial.setBounds(
    ...
    private void createSettingsOverlay() {
        ...
        Spacial overlaySpacial = spacialComponentMapper.get(overlay);
        overlaySpacial.setBounds(0, 0, GalacticTDGame.UI_WIDTH, GalacticTDGame.UI_HEIGHT);
    ...
    private void createSettingsDock() {
        ...
        Spacial dockSpacial = spacialComponentMapper.get(settingsDock);
        dockSpacial.width = GalacticTDGame.UI_WIDTH / 4f;
        dockSpacial.height = dockSpacial.width;
        ...
        dockResetCords.resetPositionY = 0 - dockSpacial.height;

        dockSpacial.x = dockResetCords.resetPositionX;
        dockSpacial.y = dockResetCords.resetPositionY;
        ...
        movementDestination.destinationX = GalacticTDGame.UI_WIDTH - dockSpacial.width;
    ...
    private int createCircleQuitButton() {
        int circleButton = archetypeBuilder.buildArchetype(archetypeBuilder.uiButton);

        Spacial circleSpacial = spacialComponentMapper.get(circleButton);
        circleSpacial.spacialType = BoundsType.Circle;
        circleSpacial.centerX = 50;
        circleSpacial.centerY = 50;
        circleSpacial.radius = 25;

        Touchable circleTouch = touchableComponentMapper.get(circleButton);
        circleTouch.acceptingTouch = true;
        circleTouch.event = new Event() {
            @Override
            public void fireEvent() {
                Gdx.app.exit();
            }
