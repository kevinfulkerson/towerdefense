...
public class GridScreen implements Screen {
	...
	public static TowerDefence game;
	...
	public GridScreen(TowerDefence game) {
	...
	public void show() {
		if (!isSetup) {
			...
			road = new Road(TowerDefence.manager);
			grid = new Grid(TowerDefence.manager, screenWidth, screenHeight - screenOffset, 10, 5, road);
			...
			offsetOverlay = new Sprite(TowerDefence.manager.get("topBar.png", Texture.class));
			offsetOverlay.setBounds(0, screenHeight-screenOffset, screenWidth, screenOffset);
			
			overlay = new Sprite(TowerDefence.manager.get("border.png", Texture.class));
			overlay.setBounds(0, 0, screenHeight, menuHeight);
			
			towerOptionOne = new Sprite(TowerDefence.manager.get("border.png",Texture.class));
			towerOptionOne.setBounds((screenHeight * 3/32), (menuHeight * 15/32), (screenHeight * 3/8), (screenHeight * 3/8));
			
			towerOneMenuImage = new Sprite(TowerDefence.manager.get("tower-green.png",Texture.class));
			towerOneMenuImage.setBounds(screenHeight * 5/32, (menuHeight * 9/16), (screenHeight/4), (screenHeight/4));
			
			towerOptionTwo = new Sprite(TowerDefence.manager.get("border.png",Texture.class));
			towerOptionTwo.setBounds((screenHeight*17/32), (menuHeight * 15/32), (screenHeight * 3/8), (screenHeight * 3/8));
			
			towerTwoMenuImage = new Sprite(TowerDefence.manager.get("tower-red.png",Texture.class));
			towerTwoMenuImage.setBounds((screenHeight*19/32),(menuHeight*9/16),(screenHeight/4),(screenHeight/4));
			
			buyButton = new Sprite(TowerDefence.manager.get("buttonBuy.png",Texture.class));
			buyButton.setBounds((screenHeight * 3/32), menuHeight/8, (screenHeight * 3/8), (menuHeight * 3/16));
			
			cancelButton = new Sprite(TowerDefence.manager.get("buttonCancel.png",Texture.class));
			cancelButton.setBounds((screenHeight * 17/32), (menuHeight/8), (screenHeight * 3/8), (menuHeight * 3/16));
			
			towerToolTip = new Sprite(TowerDefence.manager.get("border.png",Texture.class));
...
//		System.out.println("Running");
	...
	public void updateWhilePaused() {
		if(Gdx.input.justTouched()){
			...
			if(spriteWasSelected(towerOptionOne))
			{
				...
				selectedTower = 1;
				towerOptionOne.setTexture(TowerDefence.manager.get("borderSelected.png", Texture.class));
				towerOptionTwo.setTexture(TowerDefence.manager.get("border.png", Texture.class));
			} else if(spriteWasSelected(towerOptionTwo))
			{
				Gdx.input.vibrate(20);
				selectedTower = 2;
				towerOptionOne.setTexture(TowerDefence.manager.get("border.png", Texture.class));
				towerOptionTwo.setTexture(TowerDefence.manager.get("borderSelected.png", Texture.class));
			}
	...
	public void addNewTower(byte towerOption){
		switch(towerOption){
		case 1: 
			drawableEntities.add(new Tower(TowerDefence.manager.get("tower-green.png", Texture.class), gridClickedLocation, 1));
			break;
		case 2:
			drawableEntities.add(new Tower(TowerDefence.manager.get("tower-red.png", Texture.class), gridClickedLocation, 2));
			break;
		}
